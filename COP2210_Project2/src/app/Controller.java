...
//enter youinfo here
        System.out.println("===============================================");
        System.out.println("COP 2210 -Project 2Output");
        System.out.println("Dianna Bronson");
        System.out.println("6120678");
...
// check registercash as a "Manager"
// call the cashInfo method on the register object with input "Manager"
// YOUR CODE HERE        
        register.cashInfo("Manager");
...
// create aPayment variable named applePayment2 with
// 0 dollars
// 2 quarters
// 0 dimes
// 0 nickels
...
// call the buySandwichmethod on the register object with
...
// YOUR CODE HERE}
        ...
        for (int i = 1; i <= 8; i++) {
            ...
            //System.out.println(i + "\t" + meat + "\t" + cheese + "\t" + veggies);

            myOrder = new Sandwich(meat, cheese, veggies);
            myOrder.displayInfo();
            Payment myOrderPayment = new Payment(10, 0, 0, 0, 0);
            register.buySandwich(myOrder, myOrderPayment);
            register.cashInfo("Manager");
